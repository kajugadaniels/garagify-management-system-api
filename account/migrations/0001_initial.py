    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Admin', 'Admin'), ('Mechanic', 'Mechanic'), ('Storekeeper', 'Storekeeper'), ('Cashier', 'Cashier'), ('Customer', 'Customer')], max_length=30, null=True)),
